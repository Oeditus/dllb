# dllb v0.1.0 Release Announcement
## Rust-Native Multi-Model NoSQL Database for Code Intelligence & Hybrid RAG

We are excited to announce the release of **dllb v0.1.0** (Prototype Phase), a multi-model NoSQL database management system built from scratch in Rust. Natively combining **documents**, **graphs**, **full-text search**, and **vector embeddings** into a single, unified database engine, `dllb` eliminates the complexity, latency, and synchronization overhead of polyglot persistence.
